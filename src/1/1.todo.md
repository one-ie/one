...
## Initial Setup
- [x] Create new Astro project with template
  ```bash
...
- [x] Install dependencies:
  ...
  ```
- [x] Configure Astro (astro.config.mjs)
  - [x] Add React integration
  - [x] Add Tailwind integration
  - [x] Set output mode to 'server'
- [x] Setup Tailwind (tailwind.config.mjs)
  - [x] Add shadcn-ui presets
