...
args:
  ...
  content: |
    ...
    Or call (512) 555-0142 — a human answers.

    — Summit Movers · USDOT 3987654 / MC 1456789
```
...
USDOT/MC clickable to SAFER, named owner, "4,000+ moves since 2016". One CTA: book the estimate.
